...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://shaktawat.in"),
    keywords: [
      ...
      "Aryan S Shaktawat",
      "A S Shaktawat",
      "Aryan Shaktawat resume",
      "Aryan Shaktawat projects",
      "Aryan Shaktawat blog",
      "Aryan Shaktawat GitHub",
      "Aryan Shaktawat LinkedIn",
      "Aryan Shaktawat UPES",
      "Aryan Shaktawat cybersecurity",
      "Aryan Shaktawat forensics",
      "Aryan Shaktawat CSE",
      "Aryan Singh",
      "aryan singh shaktawat",
      "Aryan S",
      ...
      "AI",
      "developer",
      "Aryan Shaktawat cybersecurity and forensics",
      "Aryan Shaktawat developer",
      "Aryan Shaktawat website",
      "Aryan Shaktawat contact",
      "Aryan S Shaktawat resume PDF",
      "Aryan Shaktawat UPES Dehradun",
    ],
...
export default function RootLayout({
  ...
  <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth" className={spaceGrotesk.variable}>
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Caveat:wght@500;600;700&family=Outfit:wght@300;400;500;600;700;800;900&family=Inter:wght@300;400;500;600;700&family=Montserrat:wght@400;500;600;700;800;900&display=swap" />
      </head>
