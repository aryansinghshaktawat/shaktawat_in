...
const About = () => {
	...
	return (
		<>
			<section
				id="about"
				className="relative w-full bg-[#121318] text-white border-t border-[#202025] font-geist-mono"
			>
				<div
					aria-hidden
					className="absolute -top-px left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#3b82f652] to-transparent"
				/>
				<div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
					<div className="md:grid md:grid-cols-2 md:gap-10 items-center">
						{/* Left: Intro + CTA */}
						<div className="order-2 md:order-1">
							<h1 className="text-3xl md:text-4xl font-extrabold text-[#65cdf9] mb-4 font-space-grotesk">
								Welcome — I build and learn by doing
							</h1>
							<p className="text-[#c6c6c9] text-lg md:text-xl max-w-2xl leading-relaxed mb-6 font-geist-mono">
								I&apos;m{" "}
								<span className="font-bold text-[#e6e6e8]">
						...
						<div className="order-1 md:order-2 mb-6 md:mb-0 flex justify-center">
							<div className="w-56 md:w-72 rounded-2xl overflow-hidden ring-1 ring-[#2a2b31] bg-[#0f1116] shadow-lg">
								...
								/>
								<div className="p-4">
									<div className="text-sm text-[#9ea0a6]">
										B.Tech CSE · UPES
									</div>
									<div className="text-lg font-semibold text-white mt-1">
										Aryan Singh Shaktawat
									</div>
									<div className="mt-3 text-sm text-[#c6c6c9]">
										Hands-on in AI integrations, OSINT tooling, and
										security-focused projects.
									</div>

									<div className="mt-4 border-t border-white/6 pt-3">
										<div className="text-xs text-[#9ea0a6] mb-2">
											Recent
										</div>
