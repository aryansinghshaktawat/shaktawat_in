  ...
  return (
    <section id="education" className="w-full bg-[#0f1112] text-white border-t border-[#202025]">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="uppercase text-left font-sans font-extrabold text-2xl md:text-3xl tracking-tight mb-6">Educational Journey</h2>
        <div className="rounded-md border border-[#26272e] bg-[#181a20] p-6">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="mt-2 font-mono text-sm text-white space-y-1">
