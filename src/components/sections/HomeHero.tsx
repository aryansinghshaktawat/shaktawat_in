...
export default function HomeHero() {
  ...
  <div className="relative z-10 max-w-6xl mx-auto pt-24 pb-24 md:pt-32 md:pb-32 flex flex-col md:flex-row items-center gap-12">
        ...
        <img
          ...
          className="absolute left-0 bottom-0 w-[220px] h-[280px] md:w-[320px] md:h-[420px] object-cover object-center rounded-2xl z-20"
          style={{ maxWidth: 'none', height: 'auto', left: 0, marginLeft: 0, transform: 'scaleX(-1)' }}
        />
        {/* Right: Text (full width on mobile, shifted on desktop) */}
        <div className="w-full md:ml-[340px] text-center md:text-left flex flex-col justify-center items-center md:items-start">
